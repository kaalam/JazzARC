...
class Question(Block):
	"""
	This is the Kind containing questions (Block.type_picture instances).

	Since this PoC has no Kind implementation, a Question is a Block, but it has an additional function_classes() method
	...
	def function_classes():
		"""
		This defines DSL function collections that should be included in a Field that computes Questions.

		Note function_classes() has no self argument. It is a method of the abstract Kind while Question() is just a way
